# Join the Discord & Get Access

Discord is the only way into The Great Hall's servers. Every server is whitelisted, and all connection details are handed out through Discord onboarding. They are never posted publicly.
...
!!! note
    Onboarding is being updated. This page will be refreshed with step-by-step screenshots once the new flow is live.
